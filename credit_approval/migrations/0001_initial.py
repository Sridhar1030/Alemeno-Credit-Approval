# Generated by Django 4.2.23 on 2025-08-05 18:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_customer_csv_id', models.IntegerField(blank=True, null=True, unique=True)),
                ...
                ('current_debt', models.DecimalField(decimal_places=2, default=0.0, max_digits=12, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending Approval'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected'), ('ACTIVE', 'Active'), ('PAID', 'Paid Off')], default='PENDING', max_length=10)),
